...
const double largeSize = _largeSize;
const double massiveSize = _massiveSize;
...
double getResponsiveVerticalSpaceMedium(BuildContext context) =>
    screenWidthFraction(context, dividedBy: 14);
